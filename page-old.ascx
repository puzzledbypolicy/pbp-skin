...
<div id="homepage-background-simple-gradient">
    <div id="art-page-background-gradient">
        <div >
            <a href="/dnn6/home.aspx" class="homeLink">&nbsp;</a></div>
	    <div id="udebate-moto"></div>
    </div>
</div>
<div id="art-main">
    <div class="art-Sheet">
        ...
        <div class="art-Sheet-body">
            ...
            <div class="art-contentLayout">
                <div class="art-content-wide">
					...
					<div id="followSocial">
						...
						<img src="/dnn6/portals/0/images/utube.png" alt="follow us on youtube">
						</a>	
						<a href="http://www.flickr.com/photos/puzzledbypolicy/">
						<img src="/dnn6/portals/0/images/flicker.png" alt="follow us on flickr">
						</a>
						<a href="http://twitter.com/#!/puzzledbypolicy">
						<img src="/dnn6/portals/0/images/twit.png" alt="follow us on twitter">
						</a>
						<a href="http://www.linkedin.com/groups?about=&gid=3750508&trk=anet_ug_grppr">
						<img src="/dnn6/portals/0/images/linked.png" alt="follow us on linkedin">
						</a>
						<a href="http://www.facebook.com/pages/Puzzled-by-Policy/167052726656341">
						<img src="/dnn6/portals/0/images/facebook.png" alt="follow us on facebook">
						</a>
						<div id="foll">
            ...
            <a class="proposeSlider slide_<%=System.Threading.Thread.CurrentThread.CurrentCulture.Name%>"
                style="display: none" href="#">&nbsp;</a>
            <div id="footer">
